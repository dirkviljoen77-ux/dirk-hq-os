...
export default function BusinessNav() {
  return <nav style={{ display: "flex", gap: 8, flexWrap: "wrap", marginBottom: 24 }}>
    {[['Dashboard','/istream/dashboard'],['Quotations','/istream/quotations'],['Jobs','/istream/jobs'],['Budgets','/istream/budgets'],['Expenses','/istream/expenses'],['Clients','/istream/clients'],['Catalogue & Pricing','/istream/catalogue']].map(([label, href]) =>
