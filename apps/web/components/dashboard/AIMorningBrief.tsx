...
type Props = { projectCount: number; outstandingTasks: number; nextMeeting?: { title: string; meetingDate: Date } };

export default function AIMorningBrief({ projectCount, outstandingTasks, nextMeeting }: Props) {
  return (
